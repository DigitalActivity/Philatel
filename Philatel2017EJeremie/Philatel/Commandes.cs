...
namespace Philatel
{
    ...
    public abstract class CommandeAjout : ICommande
    {
        ...
        public bool Exécuter() // Template Method (appelle une Factory Method)
        {
            ...
            m_article = article;
            RequeteSQL.AjouterArticle(article);
            return true;
        }

        public void Annuler()
            => RequeteSQL.SupprimerArticle(m_numéroArticleAjouté);

        public void Retablir()
        {
            RequeteSQL.AjouterArticle(m_article);
        }
    ...
    public abstract class CommandeModification : ICommande
    {
        ...
        public bool Exécuter() // Template Method (appelle une Factory Method)
        {
            ...
            RequeteSQL.SupprimerArticle(m_article.Numéro);
            RequeteSQL.AjouterArticle(d.Extraire());
            return true;
        }

        public void Annuler()
        {
            m_articleSave = RequeteSQL.ArticleSelonNumero(m_article.Numéro);
            RequeteSQL.SupprimerArticle(m_article.Numéro);
            RequeteSQL.AjouterArticle(m_article);
        }
        ...
        {
            RequeteSQL.SupprimerArticle(m_article.Numéro);
            RequeteSQL.AjouterArticle(m_articleSave);
        }
    ...
    public class CommandeEffacerTout : ICommande
    {
        ...
        {
            m_tousLesArticles.AddRange(RequeteSQL.ToutesLesArticles());
        }
        ...
        public bool Exécuter()
        {
            ...
            RequeteSQL.RetirerTousLesArticles();
            return true;
        }
